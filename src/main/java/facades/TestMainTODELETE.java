...
public class TestMainTODELETE {
    public static void main(String[] args) throws Exception {
        ...
        Gson gson = new Gson();
        System.out.println(facade.getApiData(55.681554, 12.591135, "https://app.ticketmaster.com/discovery/v2/events.json?", "2019-11-23T00:00:00Z", "2019-11-25T23:59:59Z" ));
